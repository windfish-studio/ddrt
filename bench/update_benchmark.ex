...
new_tree = fn leafs,typ ->
  ...
  tree = boxes |> Enum.reduce(Drtree.new(%{type: typ}),fn {b,i},acc ->
...
Benchee.run(%{
  ...
  "merklemap" =>
    ...
    cyan() <>"all leafs of tree ["<> color(195) <>"1000" <> cyan() <> "]" <> reset() => 1000,
    cyan() <>"all leafs of tree ["<> color(195) <>"100000" <> cyan() <> "]" <> reset() => 100000
   }, time: 10)